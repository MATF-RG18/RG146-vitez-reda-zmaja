...
namespace shader {
  ...
  void TerrainShader::bindAttribute(int index, const char *variableName) {
  ...
  void TerrainShader::cleanUp(void) {
  ...
  int TerrainShader::getUniformLocation(const char *uniformName) {
  ...
  void TerrainShader::getAllUniformLocations(void) {
    ...
    this->locationBackgroundTexture = getUniformLocation("backgroundTexture");
    this->locationRTexture = getUniformLocation("rTexture");
    this->locationGTexture = getUniformLocation("gTexture");
    this->locationBTexture = getUniformLocation("bTexture");
    this->locationBlendMap = getUniformLocation("blendMap");
  }

  void TerrainShader::loadInt(int uniformLocation, int value) {

    glUniform1i(uniformLocation, value);
  }

  void TerrainShader::loadFloat(int uniformLocation, float value) {

    glUniform1f(uniformLocation, value);
  }

  void TerrainShader::loadFloatVertex(int uniformLocation, vec3 vertex) {

    glUniform3f(uniformLocation, vertex.x, vertex.y, vertex.z);
  }

  void TerrainShader::loadBoolean(int uniformLocation, bool value) {
  ...
  void TerrainShader::loadMatrix(int uniformLocation, mat4 matrix) {
  ...
  void TerrainShader::loadShineVariables(float shine, float reflectivity) {
  ...
  void TerrainShader::connectTextureUnits() {
    ...
    loadInt(this->locationBackgroundTexture, 0);
    loadInt(this->locationRTexture, 1);
    loadInt(this->locationGTexture, 2);
    loadInt(this->locationBTexture, 3);
    loadInt(this->locationBlendMap, 4);
    
  }


  int TerrainShader::loadShader(const char *fileName, GLenum type) {
  ...
  void TerrainShader::bindAttributes(void) {
