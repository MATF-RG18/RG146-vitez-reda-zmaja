////////////////////////////////////////////////////////////////////////////////
/// @file AnimatedModelShader.h
/// @brief Deklaracija klase AnimatedModelShader.
/// @author Dusan Pantelic
/// @date Maj 2019
////////////////////////////////////////////////////////////////////////////////
#ifndef _ANIMATED_MODEL_SHADER_H_
#define _ANIMATED_MODEL_SHADER_H_
...
namespace shader {
  ...
  //////////////////////////////////////////////////////////////////////////////
  /// @brief Klasa AnimatedModelShader ucitava i izvrsava programe na OpenGL Shading jeziku.
  ...
  public:
    ...
    ////////////////////////////////////////////////////////////////////////////
    AnimatedModelShader(const char *vertexShaderFile, const char *fragmentShaderFile);
    ...
    ////////////////////////////////////////////////////////////////////////////
    /// @brief Funkcija ucitava niz matrica u uniformnu varijablu.
    /// @param uniformLocation Lokacija uniformne promenljive.
    /// @param matArray Niz matrica.
    /// @param size Broj matrica.
    /// @return void
    ////////////////////////////////////////////////////////////////////////////
    void loadMatrixArray(int uniformLocation, mat4 *matArray, int size);
    ...
    ////////////////////////////////////////////////////////////////////////////
    /// @brief Funkcija ucitava niz matrica transformacije u uniformnu varijablu.
    /// @param matArray Niz matrica.
    /// @param size Broj matrica.
    /// @return void
    ////////////////////////////////////////////////////////////////////////////
    void loadBoneTransforms(mat4 *boneTransforms, int size);
